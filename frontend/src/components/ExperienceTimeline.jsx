        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
            <li>
                ...
                <div className="timeline-start mb-10 md:text-end">
                    ...
                    Created auton and driver control programs for various VEX robots using VEX C++ and helped new members learn
                </div>
                <hr />
            </li>
            <li>
                ...
                <div className="timeline-start mb-10 md:text-end">
                    <time className="font-mono italic">2025-2025</time>
